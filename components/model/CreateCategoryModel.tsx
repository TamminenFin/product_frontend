      ...
      <DialogContent className="font-plus max-w-[525px] bg-white p-6 rounded-lg shadow-lg">
        <DialogHeader>
          <DialogTitle className="text-2xl font-semibold text-gray-800">
            {translate.admin.categoriesPage.createModal.heading}
          </DialogTitle>
          <DialogDescription className="text-sm text-gray-600 mt-2">
            {translate.admin.categoriesPage.createModal.title}
          </DialogDescription>
        </DialogHeader>
        ...
        <form className="mt-3" onSubmit={handleClick}>
          ...
          >
            {translate.admin.categoriesPage.createModal.inputLabel}
          </label>
          <input
            id="name"
            ...
            type="text"
            placeholder={
              translate.admin.categoriesPage.createModal.placeholderText
            }
          ...
          <div className="flex justify-center mt-3">
            ...
            >
              {translate.admin.categoriesPage.createModal.actionButton}
            </button>
          </div>
        </form>
      </DialogContent>
